...
var Seemless = {
  ...
  generateRoutesForClientAPIAccess: function (clientURL, apiObject, namespace, httpServer) {
    //console.log("calling generateRoutesForClientAPIAccess");
    Seemless.clientAPIRoutes.push({"path": clientURL, "object": apiObject, "name":namespace});
    ...
    if(!Seemless.listenerSetup) {
      ...
      httpServer.addListener('request', Seemless.onRequest);
    }
    Seemless.BuildRoutesForObject(apiObject, httpServer, namespace);
  },

  dispathClientAPIFileRequest: function(route, req, res) {
    //res.setHeader('Content-Type', 'text/javascript');
    res.writeHead(200);
    res.write(Seemless.generateAPIForObject(route.object, route.name));
    res.end();
  },
  ...
  BuildRoutesForObject: function (objectToRoute, restServer, objectToRouteName, parentRouteName) {
    var routeString;
    ...
    for (var propName in objectToRoute) {
      ...
      switch (typeof (objectToRoute[propName])) {
        case "string": {
            ...
            var getRoute = {"type": "propertyget", "path": routeString, "childobject": propName, "parentobject": objectToRoute};
            ...
            var setRoute = {"type": "propertyset", "path": routeString, "childobject": propName, "parentobject": objectToRoute};
        ...
        case "function": {
            ...
            var functionRoute = {"type": "function", "path": routeString, "action": objectToRoute[propName], "childobject": objectToRoute[propName], "parentobject": objectToRouteName};
        ...
        case "object": {
            Seemless.BuildRoutesForObject(objectToRoute[propName], restServer, propName, objectToRouteName);
            break;
        }
      }
    }
